...
export class Api {
  ...
  httpDelete(path: string) {
    let token: string = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6NywiZW1haWwiOiJyYWhtYW5AbWFpbC5jb20iLCJpYXQiOjE3NzgxNzMwMDQsImV4cCI6MTc3ODE3NjYwNH0.nYudzapK2NLRwp2hySA_PXWF-HtIKrMvH8KthHQ9Hb0';
